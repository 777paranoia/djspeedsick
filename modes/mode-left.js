...
#define u_texEnv4 u_texEnv1
#define u_texEnv6 u_texEnv1
#define u_texEnv5 u_texEnv1
#endif
...
void main() {
    ...
    // Adaptive: on mobile (portrait) show full image, on desktop (landscape) show center crop
    ...
    vec2 laptopUV = vec2(0.3662, 0.4982);
    tuv = mix(tuv, laptopUV + (tuv - laptopUV) * 0.16, zAmt);
