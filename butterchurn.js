(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["butterchurn"] = factory();
  else root["butterchurn"] = factory();
  ...
  return /******/ (function (modules) {
    ...
    /******/ [
          ...
          (0, _createClass3.default)(ShaderUtils, null, [
            {
              ...
              value: function getShaderParts(t) {
                ...
                if (t && sbIndex > -1) {
                  ...
                  var shaderBody = afterShaderBody.substring(
                    firstCurly + 1,
                    lastCurly,
                  );
          ...
          (0, _createClass3.default)(Utils, null, [
            ...
            },
            {
              ...
              value: function range(start, end) {
                if (end === undefined) {
                  return [].concat(
                    (0, _toConsumableArray3.default)(Array(start).keys()),
                  );
                }
          ...
          (0, _createClass3.default)(WaveUtils, null, [
            {
              ...
              value: function smoothWave(
                ...
                for (var i = 0; i < nVertsIn - 1; i++) {
                  ...
                  if (zCoord) {
                    for (var _k = 0; _k < 3; _k++) {
                      positionsSmoothed[(j + 1) * 3 + _k] =
                        (c1 * positions[iBelow * 3 + _k] +
                          c2 * positions[i * 3 + _k] +
                          c3 * positions[iAbove * 3 + _k] +
                          c4 * positions[iAbove2 * 3 + _k]) *
                        invSum;
                    }
                  } else {
                    for (var _k2 = 0; _k2 < 2; _k2++) {
                      positionsSmoothed[(j + 1) * 3 + _k2] =
                        (c1 * positions[iBelow * 3 + _k2] +
                          c2 * positions[i * 3 + _k2] +
                          c3 * positions[iAbove * 3 + _k2] +
                          c4 * positions[iAbove2 * 3 + _k2]) *
                        invSum;
                    }
                ...
                for (var _k3 = 0; _k3 < 3; _k3++) {
                  positionsSmoothed[j * 3 + _k3] =
                    positions[(nVertsIn - 1) * 3 + _k3];
                }
              },
            },
            {
              key: "smoothWaveAndColor",
              value: function smoothWaveAndColor(
                positions,
                colors,
                positionsSmoothed,
                colorsSmoothed,
                ...
                for (var i = 0; i < nVertsIn - 1; i++) {
                  ...
                  if (zCoord) {
                    for (var _k4 = 0; _k4 < 3; _k4++) {
                      positionsSmoothed[(j + 1) * 3 + _k4] =
                        (c1 * positions[iBelow * 3 + _k4] +
                          c2 * positions[i * 3 + _k4] +
                          c3 * positions[iAbove * 3 + _k4] +
                          c4 * positions[iAbove2 * 3 + _k4]) *
                        invSum;
                    }
                  } else {
                    for (var _k5 = 0; _k5 < 2; _k5++) {
                      positionsSmoothed[(j + 1) * 3 + _k5] =
                        (c1 * positions[iBelow * 3 + _k5] +
                          c2 * positions[i * 3 + _k5] +
                          c3 * positions[iAbove * 3 + _k5] +
                          c4 * positions[iAbove2 * 3 + _k5]) *
                        invSum;
                    }
                    positionsSmoothed[(j + 1) * 3 + 2] = 0;
                  }
                ...
                for (var _k7 = 0; _k7 < 3; _k7++) {
                  positionsSmoothed[j * 3 + _k7] =
                    positions[(nVertsIn - 1) * 3 + _k7];
                }

                for (var _k8 = 0; _k8 < 4; _k8++) {
                  colorsSmoothed[j * 4 + _k8] =
                    colors[(nVertsIn - 1) * 4 + _k8];
                }
              },
          ...
          (0, _createClass3.default)(Visualizer, [
            ...
            },
            {
              ...
              value: function loadPreset(presetMap) {
                ...
                preset.baseVals = (0, _assign2.default)(
                  {},
                  this.baseValsDefaults,
                  preset.baseVals,
                );
                for (var i = 0; i < preset.shapes.length; i++) {
                  preset.shapes[i].baseVals = (0, _assign2.default)(
                    {},
                    this.shapeBaseValsDefaults,
                ...
                for (var _i = 0; _i < preset.waves.length; _i++) {
                  preset.waves[_i].baseVals = (0, _assign2.default)(
                    {},
                    this.waveBaseValsDefaults,
                    preset.waves[_i].baseVals,
                  );
                }

                if (typeof preset.init_eqs !== "function") {
                  /* eslint-disable no-param-reassign, no-new-func */
                  preset.init_eqs = new Function(
                    "a",
                    preset.init_eqs_str + " return a;",
                  );
                  preset.frame_eqs = new Function(
                    "a",
                    preset.frame_eqs_str + " return a;",
                  );
                  ...
                  for (var _i2 = 0; _i2 < preset.shapes.length; _i2++) {
                    if (preset.shapes[_i2].baseVals.enabled !== 0) {
                      preset.shapes[_i2] = (0, _assign2.default)(
                        {},
                        preset.shapes[_i2],
                        {
                          init_eqs: new Function(
                            "a",
                            preset.shapes[_i2].init_eqs_str + " return a;",
                          ),
                          frame_eqs: new Function(
                            "a",
                            preset.shapes[_i2].frame_eqs_str + " return a;",
                          ),
                        },
                      );
                    }
                  ...
                  for (var _i3 = 0; _i3 < preset.waves.length; _i3++) {
                    if (preset.waves[_i3].baseVals.enabled !== 0) {
                      var wave = {
                        init_eqs: new Function(
                          "a",
                          preset.waves[_i3].init_eqs_str + " return a;",
                        ),
                        frame_eqs: new Function(
                          "a",
                          preset.waves[_i3].frame_eqs_str + " return a;",
                        ),
                      };

                      if (
                        preset.waves[_i3].point_eqs_str &&
                        preset.waves[_i3].point_eqs_str !== ""
                      ) {
                        wave.point_eqs = new Function(
                          "a",
                          preset.waves[_i3].point_eqs_str + " return a;",
                        );
                      } else {
                        wave.point_eqs = "";
                      }

                      preset.waves[_i3] = (0, _assign2.default)(
                        {},
                        preset.waves[_i3],
                        wave,
                      );
            ...
            },
            {
              ...
              value: function updateAudio(
                ...
                for (var i = 0; i < this.numSamps; i++) {
                  this.timeArray.push((timeByteArray[i] - 128) * 2);
                  this.timeArrayL.push(timeByteArrayL[i] - 128);
                  this.timeArrayR.push(timeByteArrayR[i] - 128);

                  tempTimeL[i] =
                    0.5 * (this.timeArrayL[i] + this.timeArrayL[lastIdx]);
                  tempTimeR[i] =
                    0.5 * (this.timeArrayR[i] + this.timeArrayR[lastIdx]);
                  lastIdx = i;
                }

                this.freqArray = this.fft
                  .timeToFrequencyDomain(this.timeArray)
                  .map((val) => val * 1.5);
                this.freqArrayL = this.fft
                  .timeToFrequencyDomain(tempTimeL)
                  .map((val) => val * 1.5);
                this.freqArrayR = this.fft
                  .timeToFrequencyDomain(tempTimeR)
                  .map((val) => val * 1.5);
              },
            },
            {
          ...
          (0, _createClass3.default)(FFT, [
            {
              ...
              value: function initEqualizeTable() {
                ...
                for (var i = 0; i < this.samplesOut; i++) {
                  this.equalize[i] =
                    -0.01 * Math.log((this.samplesOut - i) * invHalfNFREQ);
                }
              },
            ...
            },
            {
              ...
              value: function timeToFrequencyDomain(waveDataIn) {
                ...
                for (var _i3 = 0; _i3 < this.samplesOut; _i3++) {
                  spectralDataOut[_i3] =
                    this.equalize[_i3] *
                    Math.sqrt(real[_i3] * real[_i3] + imag[_i3] * imag[_i3]);
                }
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var _presetEquationRunner2 = _interopRequireDefault(
          _presetEquationRunner,
        );
        ...
        var Renderer = (function () {
          function Renderer(gl, audio, opts) {
            ...
            this.warpShader = new _warp2.default(
              gl,
              this.noise,
              this.image,
              params,
            );
            this.compShader = new _comp2.default(
              gl,
              this.noise,
              this.image,
              params,
            ...
            this.prevWarpShader = new _warp2.default(
              gl,
              this.noise,
              this.image,
              params,
            );
            this.prevCompShader = new _comp2.default(
              gl,
              this.noise,
              this.image,
              params,
            ...
            this.blurShader1 = new _blur2.default(
              0,
              this.blurRatios,
              gl,
              params,
            );
            this.blurShader2 = new _blur2.default(
              1,
              this.blurRatios,
              gl,
              params,
            );
            this.blurShader3 = new _blur2.default(
              2,
              this.blurRatios,
              gl,
              params,
            ...
            this.prevCustomWaveforms = _utils2.default
              .range(4)
              .map(function (i) {
                return new _customWaveform2.default(i, gl, params);
              });
            ...
            this.presetEquationRunner = new _presetEquationRunner2.default(
              this.preset,
              globalVars,
              params,
            );
            this.prevPresetEquationRunner = new _presetEquationRunner2.default(
              this.prevPreset,
              globalVars,
              params,
            );
          ...
          (0, _createClass3.default)(
            ...
            [
              {
                ...
                value: function loadPreset(preset, blendTime) {
                  ...
                  this.presetEquationRunner =
                    new _presetEquationRunner2.default(
                      this.preset,
                      globalVars,
                      params,
                    );
              ...
              },
              {
                ...
                value: function setRendererSize(width, height, opts) {
                  ...
                  if (
                    this.texsizeX !== oldTexsizeX ||
                    this.texsizeY !== oldTexsizeY
                  ) {
              ...
              },
              {
                ...
                value: function calcTimeAndFPS(elapsedTime) {
                  ...
                  var newHistTime =
                    this.timeHist[this.timeHist.length - 1] + elapsed;
                  ...
                  var newFPS =
                    this.timeHist.length / (newHistTime - this.timeHist[0]);
                  if (
                    Math.abs(newFPS - this.fps) > 3.0 &&
                    this.frame > this.timeHistMax
                  ) {
                    this.fps = newFPS;
                  } else {
                    var damping = 0.93;
              ...
              },
              {
                ...
                value: function runPixelEquations(
                  preset,
                  mdVSFrame,
                  runVertEQs,
                  blending,
                  ...
                  for (var iz = 0; iz < gridZ1; iz++) {
                    for (var ix = 0; ix < gridX1; ix++) {
                      ...
                      if (!blending) {
                        ...
                        var mix2 =
                          this.blendPattern.vertInfoA[offset / 2] *
                            this.blendProgress +
                          this.blendPattern.vertInfoC[offset / 2];
                        mix2 = Math.clamp(mix2, 0, 1);

                        this.warpUVs[offset] =
                          this.warpUVs[offset] * mix2 + u * (1 - mix2);
              ...
              },
              {
                ...
                value: function bindFrambufferAndSetViewport(
                  fb,
                  width,
                  height,
                ) {
              ...
              },
              {
                ...
                value: function bindFrameBufferTexture(
                  targetFrameBuffer,
                  targetTexture,
                ) {
              ...
              },
              {
                ...
                value: function render() {
                  ...
                  prevGlobalVars.gmegabuf =
                    this.prevPresetEquationRunner.gmegabuf;
                  ...
                  (0, _assign2.default)(
                    this.regVars,
                    _utils2.default.pick(this.mdVSVertex, this.regs),
                  );
                  (0, _assign2.default)(globalVars, this.regVars);

                  var mdVSFrameMixed = void 0;
                  if (this.blending) {
                    this.prevPresetEquationRunner.runFrameEquations(
                      prevGlobalVars,
                    );
                    this.runPixelEquations(
                  ...
                  this.motionVectors.drawMotionVectors(
                    mdVSFrameMixed,
                    this.warpUVs,
                  );
                  ...
                  if (this.preset.shapes && this.preset.shapes.length > 0) {
                    this.customShapes.forEach(function (shape, i) {
                      shape.drawCustomShape(
                        _this.blending ? _this.blendProgress : 1,
                        globalVars,
                        _this.presetEquationRunner,
                        _this.preset.shapes[i],
                        _this.prevTexture,
                      );
                    });
                  }
                  ...
                  if (this.preset.waves && this.preset.waves.length > 0) {
                    this.customWaveforms.forEach(function (waveform, i) {
                      waveform.drawCustomWaveform(
                        _this.blending ? _this.blendProgress : 1,
                        _this.audio.timeArrayL,
                        _this.audio.timeArrayR,
                        _this.audio.freqArrayL,
                        _this.audio.freqArrayR,
                        globalVars,
                        _this.presetEquationRunner,
                        _this.preset.waves[i],
                      );
                    });
                  }
                  ...
                  if (this.blending) {
                    if (
                      ...
                      this.prevCustomShapes.forEach(function (shape, i) {
                        shape.drawCustomShape(
                          1.0 - _this.blendProgress,
                          prevGlobalVars,
                          _this.prevPresetEquationRunner,
                          _this.prevPreset.shapes[i],
                          _this.prevTexture,
                        );
                      });
                    }
              ...
              },
              {
                ...
                value: function renderToScreen() {
                  ...
                  var _Renderer$getBlurValu2 = Renderer.getBlurValues(
                      this.mdVSFrameMixed,
                    ),
              ...
              },
              {
                ...
                value: function toDataURL() {
                  ...
                  var _Renderer$getBlurValu3 = Renderer.getBlurValues(
                      this.mdVSFrameMixed,
                    ),
                  ...
                  (0, _from2.default)(
                    ...
                    function (val, i) {
                      return data.slice(
                        i * _this2.texsizeX * 4,
                        (i + 1) * _this2.texsizeX * 4,
                      );
                    },
                  ).forEach(function (val, i) {
                    return data.set(
                      val,
                      (_this2.texsizeY - i - 1) * _this2.texsizeX * 4,
                    );
                  });
            ...
            [
              ...
              },
              {
                ...
                value: function mixFrameEquations(
                  blendProgress,
                  mdVSFrame,
                  mdVSFramePrev,
                ) {
                  ...
                  mixedFrame.decay =
                    mix * mdVSFrame.decay + mix2 * mdVSFramePrev.decay;
                  mixedFrame.wave_a =
                    mix * mdVSFrame.wave_a + mix2 * mdVSFramePrev.wave_a;
                  mixedFrame.wave_r =
                    mix * mdVSFrame.wave_r + mix2 * mdVSFramePrev.wave_r;
                  mixedFrame.wave_g =
                    mix * mdVSFrame.wave_g + mix2 * mdVSFramePrev.wave_g;
                  mixedFrame.wave_b =
                    mix * mdVSFrame.wave_b + mix2 * mdVSFramePrev.wave_b;
                  mixedFrame.wave_x =
                    mix * mdVSFrame.wave_x + mix2 * mdVSFramePrev.wave_x;
                  mixedFrame.wave_y =
                    mix * mdVSFrame.wave_y + mix2 * mdVSFramePrev.wave_y;
                  mixedFrame.wave_mystery =
                    mix * mdVSFrame.wave_mystery +
                    mix2 * mdVSFramePrev.wave_mystery;
                  mixedFrame.ob_size =
                    mix * mdVSFrame.ob_size + mix2 * mdVSFramePrev.ob_size;
                  mixedFrame.ob_r =
                    mix * mdVSFrame.ob_r + mix2 * mdVSFramePrev.ob_r;
                  mixedFrame.ob_g =
                    mix * mdVSFrame.ob_g + mix2 * mdVSFramePrev.ob_g;
                  mixedFrame.ob_b =
                    mix * mdVSFrame.ob_b + mix2 * mdVSFramePrev.ob_b;
                  mixedFrame.ob_a =
                    mix * mdVSFrame.ob_a + mix2 * mdVSFramePrev.ob_a;
                  mixedFrame.ib_size =
                    mix * mdVSFrame.ib_size + mix2 * mdVSFramePrev.ib_size;
                  mixedFrame.ib_r =
                    mix * mdVSFrame.ib_r + mix2 * mdVSFramePrev.ib_r;
                  mixedFrame.ib_g =
                    mix * mdVSFrame.ib_g + mix2 * mdVSFramePrev.ib_g;
                  mixedFrame.ib_b =
                    mix * mdVSFrame.ib_b + mix2 * mdVSFramePrev.ib_b;
                  mixedFrame.ib_a =
                    mix * mdVSFrame.ib_a + mix2 * mdVSFramePrev.ib_a;
                  mixedFrame.mv_x =
                    mix * mdVSFrame.mv_x + mix2 * mdVSFramePrev.mv_x;
                  mixedFrame.mv_y =
                    mix * mdVSFrame.mv_y + mix2 * mdVSFramePrev.mv_y;
                  mixedFrame.mv_dx =
                    mix * mdVSFrame.mv_dx + mix2 * mdVSFramePrev.mv_dx;
                  mixedFrame.mv_dy =
                    mix * mdVSFrame.mv_dy + mix2 * mdVSFramePrev.mv_dy;
                  mixedFrame.mv_l =
                    mix * mdVSFrame.mv_l + mix2 * mdVSFramePrev.mv_l;
                  mixedFrame.mv_r =
                    mix * mdVSFrame.mv_r + mix2 * mdVSFramePrev.mv_r;
                  mixedFrame.mv_g =
                    mix * mdVSFrame.mv_g + mix2 * mdVSFramePrev.mv_g;
                  mixedFrame.mv_b =
                    mix * mdVSFrame.mv_b + mix2 * mdVSFramePrev.mv_b;
                  mixedFrame.mv_a =
                    mix * mdVSFrame.mv_a + mix2 * mdVSFramePrev.mv_a;
                  mixedFrame.echo_zoom =
                    mix * mdVSFrame.echo_zoom + mix2 * mdVSFramePrev.echo_zoom;
                  mixedFrame.echo_alpha =
                    mix * mdVSFrame.echo_alpha +
                    mix2 * mdVSFramePrev.echo_alpha;
                  mixedFrame.echo_orient =
                    mix * mdVSFrame.echo_orient +
                    mix2 * mdVSFramePrev.echo_orient;
                  mixedFrame.wave_dots =
                    mix < snapPoint
                      ? mdVSFramePrev.wave_dots
                      : mdVSFrame.wave_dots;
                  mixedFrame.wave_thick =
                    mix < snapPoint
                      ? mdVSFramePrev.wave_thick
                      : mdVSFrame.wave_thick;
                  mixedFrame.additivewave =
                    mix < snapPoint
                      ? mdVSFramePrev.additivewave
                      : mdVSFrame.additivewave;
                  mixedFrame.wave_brighten =
                    mix < snapPoint
                      ? mdVSFramePrev.wave_brighten
                      : mdVSFrame.wave_brighten;
                  mixedFrame.darken_center =
                    mix < snapPoint
                      ? mdVSFramePrev.darken_center
                      : mdVSFrame.darken_center;
                  mixedFrame.gammaadj =
                    mix < snapPoint
                      ? mdVSFramePrev.gammaadj
                      : mdVSFrame.gammaadj;
                  mixedFrame.wrap =
                    mix < snapPoint ? mdVSFramePrev.wrap : mdVSFrame.wrap;
                  mixedFrame.invert =
                    mix < snapPoint ? mdVSFramePrev.invert : mdVSFrame.invert;
                  mixedFrame.brighten =
                    mix < snapPoint
                      ? mdVSFramePrev.brighten
                      : mdVSFrame.brighten;
                  mixedFrame.darken =
                  ...
                  mixedFrame.solarize =
                    mix < snapPoint
                      ...
                      : mdVSFrame.solarize;
                  mixedFrame.b1n =
                    mix * mdVSFrame.b1n + mix2 * mdVSFramePrev.b1n;
                  mixedFrame.b2n =
                    mix * mdVSFrame.b2n + mix2 * mdVSFramePrev.b2n;
                  mixedFrame.b3n =
                    mix * mdVSFrame.b3n + mix2 * mdVSFramePrev.b3n;
                  mixedFrame.b1x =
                    mix * mdVSFrame.b1x + mix2 * mdVSFramePrev.b1x;
                  mixedFrame.b2x =
                    mix * mdVSFrame.b2x + mix2 * mdVSFramePrev.b2x;
                  mixedFrame.b3x =
                    mix * mdVSFrame.b3x + mix2 * mdVSFramePrev.b3x;
                  mixedFrame.b1ed =
                    mix * mdVSFrame.b1ed + mix2 * mdVSFramePrev.b1ed;
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var ITERATOR = __webpack_require__(10)("iterator");
        var Iterators = __webpack_require__(31);
        module.exports = __webpack_require__(3).getIteratorMethod = function (
          it,
        ) {
          if (it != undefined)
                ...
                value: function updateAudioLevels(fps, frame) {
                  if (this.audio.freqArray.length > 0) {
                    ...
                    for (var _i = 0; _i < 3; _i++) {
                      ...
                      rate = AudioLevels.adjustRateToFPS(
                        rate,
                        30.0,
                        effectiveFPS,
                      );
            ...
            [
              {
                ...
                value: function isFiniteNumber(num) {
                  return (
                    (0, _isFinite2.default)(num) && !(0, _isNan2.default)(num)
                  );
                },
              },
              {
          ...
          (0, _createClass3.default)(PresetEquationRunner, [
            {
              ...
              value: function initializeEquations(globalVars) {
                ...
                var nonUserKeys = this.qs.concat(
                  this.regs,
                  (0, _keys2.default)(this.mdVS),
                );

                var mdVSAfterInit = this.preset.init_eqs(
                  _utils2.default.cloneVars(this.mdVS),
                );

                this.mdVSQInit = _utils2.default.pick(mdVSAfterInit, this.qs);
                this.mdVSRegs = _utils2.default.pick(mdVSAfterInit, this.regs);
                var initUserVars = _utils2.default.pick(
                  mdVSAfterInit,
                  (0, _keys2.default)(
                    _utils2.default.omit(mdVSAfterInit, nonUserKeys),
                  ),
                );
                ...
                this.mdVSUserKeys = (0, _keys2.default)(
                  _utils2.default.omit(this.mdVSFrame, nonUserKeys),
                );

                this.mdVSFrameMap = _utils2.default.pick(
                  this.mdVSFrame,
                  this.mdVSUserKeys,
                );

                this.mdVSQAfterFrame = _utils2.default.pick(
                  this.mdVSFrame,
                  this.qs,
                );
                ...
                if (this.preset.waves && this.preset.waves.length > 0) {
                  for (var i = 0; i < this.preset.waves.length; i++) {
                    ...
                    if (baseVals.enabled !== 0) {
                      var mdVSWave = (0, _assign2.default)(
                        {},
                        baseVals,
                        mdVSBase,
                      );

                      var nonUserWaveKeys = this.qs.concat(
                        this.ts,
                        this.regs,
                        (0, _keys2.default)(mdVSWave),
                      );
                      ...
                      if (wave.init_eqs) {
                        ...
                        this.mdVSRegs = _utils2.default.pick(
                          mdVSWave,
                          this.regs,
                        );
                      ...
                      this.mdVSTWaveInits.push(
                        _utils2.default.pick(mdVSWave, this.ts),
                      );

                      this.mdVSUserKeysWaves.push(
                        (0, _keys2.default)(
                          _utils2.default.omit(mdVSWave, nonUserWaveKeys),
                        ),
                      );
                      this.mdVSFrameMapWaves.push(
                        _utils2.default.pick(
                          mdVSWave,
                          this.mdVSUserKeysWaves[i],
                        ),
                      );
                    } else {
                      this.mdVSWaves.push({});
                ...
                if (this.preset.shapes && this.preset.shapes.length > 0) {
                  for (var _i = 0; _i < this.preset.shapes.length; _i++) {
                    ...
                    if (_baseVals.enabled !== 0) {
                      var mdVSShape = (0, _assign2.default)(
                        {},
                        _baseVals,
                        mdVSBase,
                      );

                      var nonUserShapeKeys = this.qs.concat(
                        this.ts,
                        this.regs,
                        (0, _keys2.default)(mdVSShape),
                      );
                      ...
                      this.mdVSTShapeInits.push(
                        _utils2.default.pick(mdVSShape, this.ts),
                      );

                      this.mdVSUserKeysShapes.push(
                        (0, _keys2.default)(
                          _utils2.default.omit(mdVSShape, nonUserShapeKeys),
                        ),
                      );
                      this.mdVSFrameMapShapes.push(
                        _utils2.default.pick(
                          mdVSShape,
                          this.mdVSUserKeysShapes[_i],
                        ),
                      );
                    } else {
            ...
            },
            {
              ...
              value: function runFrameEquations(globalVars) {
                this.mdVSFrame = (0, _assign2.default)(
                  {},
                  this.mdVS,
                  this.mdVSQInit,
                  this.mdVSFrameMap,
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var BasicWaveform = (function () {
          function BasicWaveform(gl) {
            ...
            this.smoothedPositions = new Float32Array(
              (numAudioSamples * 2 - 1) * 3,
            );
            this.smoothedPositions2 = new Float32Array(
              (numAudioSamples * 2 - 1) * 3,
            );
            this.color = [0, 0, 0, 1];
            ...
            this.floatPrecision =
              _shaderUtils2.default.getFragmentFloatPrecision(this.gl);
            this.createShader();
            ...
            [
              ...
              },
              {
                ...
                value: function createShader() {
                  ...
                  var fragShader = this.gl.createShader(
              ...
              },
              {
                ...
                value: function generateWaveform(
                  ...
                  var vol =
                    (mdVSFrame.bass + mdVSFrame.mid + mdVSFrame.treb) / 3.0;

                  if (vol > -0.01 && alpha > 0.001 && timeArrayL.length > 0) {
                    var waveL = BasicWaveform.processWaveform(
                      timeArrayL,
                      mdVSFrame,
                    );
                    var waveR = BasicWaveform.processWaveform(
                      timeArrayR,
                      mdVSFrame,
                    );
                    ...
                    for (var it = 0; it < its; it++) {
                      ...
                      if (waveMode === 0) {
                        if (mdVSFrame.modwavealphabyvolume > 0) {
                          var alphaDiff =
                            mdVSFrame.modwavealphaend -
                            mdVSFrame.modwavealphastart;
                          alpha *=
                            (vol - mdVSFrame.modwavealphastart) / alphaDiff;
                        }
                        alpha = Math.clamp(alpha, 0, 1);

                        numVert = Math.floor(waveL.length / 2) + 1;
                        var numVertInv = 1.0 / (numVert - 1);
                        var sampleOffset = Math.floor(
                          (waveL.length - numVert) / 2,
                        );
                        for (var i = 0; i < numVert - 1; i++) {
                          var rad =
                            0.5 + 0.4 * waveR[i + sampleOffset] + fWaveParam2;
                          var ang =
                            i * numVertInv * 2 * Math.PI + mdVSFrame.time * 0.2;
                          ...
                          if (i < numVert / 10) {
                            ...
                            var rad2 =
                              0.5 +
                              0.4 * waveR[i + numVert + sampleOffset] +
                              fWaveParam2;
                        ...
                        if (mdVSFrame.modwavealphabyvolume > 0) {
                          var _alphaDiff =
                            ...
                            mdVSFrame.modwavealphastart;
                          alpha *=
                            (vol - mdVSFrame.modwavealphastart) / _alphaDiff;
                        }
                        alpha = Math.clamp(alpha, 0, 1);
                        ...
                        for (var _i = 0; _i < numVert; _i++) {
                          ...
                          var _ang =
                            waveL[_i + 32] * 0.5 * Math.PI +
                            mdVSFrame.time * 2.3;

                          positions[_i * 3 + 0] =
                            _rad * Math.cos(_ang) * this.aspecty + wavePosX;
                          positions[_i * 3 + 1] =
                            _rad * Math.sin(_ang) * this.aspectx + wavePosY;
                          positions[_i * 3 + 2] = 0;
                        }
                      } else if (waveMode === 2) {
                        ...
                        if (mdVSFrame.modwavealphabyvolume > 0) {
                          var _alphaDiff2 =
                            ...
                            mdVSFrame.modwavealphastart;
                          alpha *=
                            (vol - mdVSFrame.modwavealphastart) / _alphaDiff2;
                        }
                        alpha = Math.clamp(alpha, 0, 1);
                        ...
                        for (var _i2 = 0; _i2 < waveL.length; _i2++) {
                          positions[_i2 * 3 + 0] =
                            waveR[_i2] * this.aspecty + wavePosX;
                          positions[_i2 * 3 + 1] =
                            waveL[(_i2 + 32) % waveL.length] * this.aspectx +
                            wavePosY;
                          positions[_i2 * 3 + 2] = 0;
                        }
                      } else if (waveMode === 3) {
                        ...
                        if (mdVSFrame.modwavealphabyvolume > 0) {
                          var _alphaDiff3 =
                            ...
                            mdVSFrame.modwavealphastart;
                          alpha *=
                            (vol - mdVSFrame.modwavealphastart) / _alphaDiff3;
                        }
                        alpha = Math.clamp(alpha, 0, 1);
                        ...
                        for (var _i3 = 0; _i3 < waveL.length; _i3++) {
                          positions[_i3 * 3 + 0] =
                            waveR[_i3] * this.aspecty + wavePosX;
                          positions[_i3 * 3 + 1] =
                            waveL[(_i3 + 32) % waveL.length] * this.aspectx +
                            wavePosY;
                          positions[_i3 * 3 + 2] = 0;
                        }
                      } else if (waveMode === 4) {
                        if (mdVSFrame.modwavealphabyvolume > 0) {
                          var _alphaDiff4 =
                            ...
                            mdVSFrame.modwavealphastart;
                          alpha *=
                            (vol - mdVSFrame.modwavealphastart) / _alphaDiff4;
                        }
                        alpha = Math.clamp(alpha, 0, 1);
                        ...
                        for (var _i4 = 0; _i4 < numVert; _i4++) {
                          var x =
                            2.0 * _i4 * _numVertInv +
                            (wavePosX - 1) +
                            waveR[(_i4 + 25 + _sampleOffset) % waveL.length] *
                              0.44;
                          ...
                          if (_i4 > 1) {
                            x =
                              x * w2 +
                              w1 *
                                (positions[(_i4 - 1) * 3 + 0] * 2.0 -
                                  positions[(_i4 - 2) * 3 + 0]);
                            y =
                              y * w2 +
                              w1 *
                                (positions[(_i4 - 1) * 3 + 1] * 2.0 -
                                  positions[(_i4 - 2) * 3 + 1]);
                          }
                        ...
                        if (mdVSFrame.modwavealphabyvolume > 0) {
                          var _alphaDiff5 =
                            ...
                            mdVSFrame.modwavealphastart;
                          alpha *=
                            (vol - mdVSFrame.modwavealphastart) / _alphaDiff5;
                        }
                        alpha = Math.clamp(alpha, 0, 1);
                        ...
                        for (var _i5 = 0; _i5 < waveL.length; _i5++) {
                          ...
                          var x0 =
                            waveR[_i5] * waveL[ioff] + waveL[_i5] * waveR[ioff];
                          var y0 =
                            waveR[_i5] * waveR[_i5] - waveL[ioff] * waveL[ioff];

                          positions[_i5 * 3 + 0] =
                            (x0 * cosRot - y0 * sinRot) *
                            (this.aspecty + wavePosX);
                          positions[_i5 * 3 + 1] =
                            (x0 * sinRot + y0 * cosRot) *
                            (this.aspectx + wavePosY);
                          positions[_i5 * 3 + 2] = 0;
                        }
                        ...
                        if (mdVSFrame.modwavealphabyvolume > 0) {
                          var _alphaDiff6 =
                            ...
                            mdVSFrame.modwavealphastart;
                          alpha *=
                            (vol - mdVSFrame.modwavealphastart) / _alphaDiff6;
                        }
                        alpha = Math.clamp(alpha, 0, 1);
                        ...
                        var edgex = [
                          wavePosX * Math.cos(_ang2 + Math.PI * 0.5) - dx * 3.0,
                          wavePosX * Math.cos(_ang2 + Math.PI * 0.5) + dx * 3.0,
                        ];
                        var edgey = [
                          wavePosX * Math.sin(_ang2 + Math.PI * 0.5) - dy * 3.0,
                          wavePosX * Math.sin(_ang2 + Math.PI * 0.5) + dy * 3.0,
                        ];
                        ...
                        if (waveMode === 6) {
                          for (var _i7 = 0; _i7 < numVert; _i7++) {
                            ...
                            positions[_i7 * 3 + 0] =
                              edgex[0] + dx * _i7 + perpDx * 0.25 * sample;
                            positions[_i7 * 3 + 1] =
                              edgey[0] + dy * _i7 + perpDy * 0.25 * sample;
                            positions[_i7 * 3 + 2] = 0;
                          }
                        } else if (waveMode === 7) {
                          ...
                          for (var _i8 = 0; _i8 < numVert; _i8++) {
                            ...
                            positions[_i8 * 3 + 0] =
                              edgex[0] +
                              dx * _i8 +
                              perpDx * (0.25 * _sample + sep);
                            positions[_i8 * 3 + 1] =
                              edgey[0] +
                              dy * _i8 +
                              perpDy * (0.25 * _sample + sep);
                            positions[_i8 * 3 + 2] = 0;
                          }
                          ...
                          for (var _i9 = 0; _i9 < numVert; _i9++) {
                            ...
                            positions2[_i9 * 3 + 0] =
                              edgex[0] +
                              dx * _i9 +
                              perpDx * (0.25 * _sample2 - sep);
                            positions2[_i9 * 3 + 1] =
                              edgey[0] +
                              dy * _i9 +
                              perpDy * (0.25 * _sample2 - sep);
                    ...
                    if (this.oldNumVert > 0) {
                      if (newWaveMode === 7) {
                        ...
                        for (var _i10 = 0; _i10 < this.numVert; _i10++) {
                          ...
                          var _x2 =
                            this.oldPositions[nIdx * 3 + 0] * (1 - _t) +
                            this.oldPositions[(nIdx + 1) * 3 + 0] * _t;
                          var _y =
                            this.oldPositions[nIdx * 3 + 1] * (1 - _t) +
                            this.oldPositions[(nIdx + 1) * 3 + 1] * _t;

                          this.positions[_i10 * 3 + 0] =
                            this.positions[_i10 * 3 + 0] * mix + _x2 * mix2;
                          this.positions[_i10 * 3 + 1] =
                            this.positions[_i10 * 3 + 1] * mix + _y * mix2;
                        ...
                        for (var _i11 = 0; _i11 < this.numVert; _i11++) {
                          ...
                          var _x3 =
                            this.oldPositions[_nIdx * 3 + 0] * (1 - _t2) +
                            this.oldPositions[(_nIdx + 1) * 3 + 0] * _t2;
                          var _y2 =
                            this.oldPositions[_nIdx * 3 + 1] * (1 - _t2) +
                            this.oldPositions[(_nIdx + 1) * 3 + 1] * _t2;

                          this.positions2[_i11 * 3 + 0] =
                            this.positions2[_i11 * 3 + 0] * mix + _x3 * mix2;
                          this.positions2[_i11 * 3 + 1] =
                            this.positions2[_i11 * 3 + 1] * mix + _y2 * mix2;
                        ...
                        for (var _i12 = 0; _i12 < halfNumVert; _i12++) {
                          ...
                          var _x4 =
                            this.oldPositions[_nIdx2 * 3 + 0] * (1 - _t3) +
                            this.oldPositions[(_nIdx2 + 1) * 3 + 0] * _t3;
                          var _y3 =
                            this.oldPositions[_nIdx2 * 3 + 1] * (1 - _t3) +
                            this.oldPositions[(_nIdx2 + 1) * 3 + 1] * _t3;

                          this.positions[_i12 * 3 + 0] =
                            this.positions[_i12 * 3 + 0] * mix + _x4 * mix2;
                          this.positions[_i12 * 3 + 1] =
                            this.positions[_i12 * 3 + 1] * mix + _y3 * mix2;
                        ...
                        for (var _i13 = 0; _i13 < halfNumVert; _i13++) {
                          ...
                          var _x5 =
                            this.oldPositions2[_nIdx3 * 3 + 0] * (1 - _t4) +
                            this.oldPositions2[(_nIdx3 + 1) * 3 + 0] * _t4;
                          var _y4 =
                            this.oldPositions2[_nIdx3 * 3 + 1] * (1 - _t4) +
                            this.oldPositions2[(_nIdx3 + 1) * 3 + 1] * _t4;

                          this.positions2[_i13 * 3 + 0] =
                            this.positions[(_i13 + halfNumVert) * 3 + 0] * mix +
                            _x5 * mix2;
                          this.positions2[_i13 * 3 + 1] =
                            this.positions[(_i13 + halfNumVert) * 3 + 1] * mix +
                            _y4 * mix2;
                        ...
                        for (var _i14 = 0; _i14 < this.numVert; _i14++) {
                          ...
                          var _x6 =
                            this.oldPositions[_nIdx4 * 3 + 0] * (1 - _t5) +
                            this.oldPositions[(_nIdx4 + 1) * 3 + 0] * _t5;
                          var _y5 =
                            this.oldPositions[_nIdx4 * 3 + 1] * (1 - _t5) +
                            this.oldPositions[(_nIdx4 + 1) * 3 + 1] * _t5;

                          this.positions[_i14 * 3 + 0] =
                            this.positions[_i14 * 3 + 0] * mix + _x6 * mix2;
                          this.positions[_i14 * 3 + 1] =
                            this.positions[_i14 * 3 + 1] * mix + _y5 * mix2;
                    ...
                    for (var _i15 = 0; _i15 < this.numVert; _i15++) {
                      this.positions[_i15 * 3 + 1] =
                        -this.positions[_i15 * 3 + 1];
                    }

                    this.smoothedNumVert = this.numVert * 2 - 1;
                    _waveUtils2.default.smoothWave(
                      this.positions,
              ...
              },
              {
                ...
                value: function drawBasicWaveform(
                  blending,
                  blendProgress,
                  timeArrayL,
                  timeArrayR,
                  ...
                  if (
                    ...
                    var instances = 1;
                    if (
                      mdVSFrame.wave_thick !== 0 ||
                      mdVSFrame.wave_dots !== 0
                    ) {
                      instances = 4;
                    }
                    ...
                    if (waveMode === 7) {
                      ...
                      for (var _i17 = 0; _i17 < instances; _i17++) {
                        ...
                        if (_i17 === 0) {
                          ...
                          this.gl.uniform2fv(this.thickOffsetLoc, [
                            _offset / this.texsizeX,
                            0,
                          ]);
                        } else if (_i17 === 2) {
                          this.gl.uniform2fv(this.thickOffsetLoc, [
                            0,
                            _offset / this.texsizeY,
                          ]);
                        } else if (_i17 === 3) {
                          this.gl.uniform2fv(this.thickOffsetLoc, [
                            _offset / this.texsizeX,
            ...
            [
              {
                ...
                value: function processWaveform(timeArray, mdVSFrame) {
                  ...
                  for (var i = 1; i < timeArray.length; i++) {
                    waveform.push(
                      timeArray[i] * smooth2 + waveform[i - 1] * smooth,
                    );
                  }
        ...
        var CustomWaveform = (function () {
          ...
          (0, _createClass3.default)(CustomWaveform, [
            ...
            },
            {
              ...
              value: function generateWaveform(
                ...
                if (waveEqs.baseVals.enabled !== 0 && timeArrayL.length > 0) {
                  ...
                  if (
                    this.samples >= 2 ||
                    (usedots !== 0 && this.samples >= 1)
                  ) {
                    var useSpectrum = spectrum !== 0;
                    var scale =
                      (useSpectrum ? 0.15 : 0.004) * scaling * waveScale;
                    ...
                    for (var _j = this.samples - 2; _j >= 0; _j--) {
                      this.pointsData[0][_j] =
                        this.pointsData[0][_j] * mix2 +
                        this.pointsData[0][_j + 1] * mix1;
                      this.pointsData[1][_j] =
                        this.pointsData[1][_j] * mix2 +
                        this.pointsData[1][_j + 1] * mix1;
                    }
                    ...
                    var mdvsUserKeysWave =
                      presetEquationRunner.mdVSUserKeysWaves[this.index];
                    var mdVSNewFrameMapWave = _utils2.default.pick(
                      mdVSWaveFrame,
                      mdvsUserKeysWave,
                    );
                    ...
                    if (usedots === 0) {
                      _waveUtils2.default.smoothWaveAndColor(
                        this.positions,
                        this.colors,
                        this.smoothedPositions,
                        this.smoothedColors,
            ...
            },
            {
              ...
              value: function drawCustomWaveform(
                blendProgress,
                timeArrayL,
                timeArrayR,
                freqArrayL,
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var CustomShape = (function () {
          ...
          (0, _createClass3.default)(CustomShape, [
            ...
            {
              key: "drawCustomShape",
              value: function drawCustomShape(
                blendProgress,
                globalVars,
                presetEquationRunner,
                shapeEqs,
                ...
                if (shapeEqs.baseVals.enabled !== 0) {
                  ...
                  for (var j = 0; j < numInst; j++) {
                    ...
                    for (var k = 1; k <= sides + 1; k++) {
                      ...
                      if (isTextured) {
                        ...
                        this.uvs[k * 2 + 0] =
                          0.5 +
                          ((0.5 * Math.cos(texAngSum)) / texZoom) *
                            this.aspecty;
                        this.uvs[k * 2 + 1] =
                          0.5 + (0.5 * Math.sin(texAngSum)) / texZoom;
                      }

                      if (hasBorder) {
                        this.borderPositions[(k - 1) * 3 + 0] =
                          this.positions[k * 3 + 0];
                        this.borderPositions[(k - 1) * 3 + 1] =
                          this.positions[k * 3 + 1];
                        this.borderPositions[(k - 1) * 3 + 2] =
                          this.positions[k * 3 + 2];
                      }
                    }
                  ...
                  var mdVSUserKeysShape =
                    presetEquationRunner.mdVSUserKeysShapes[this.index];
                  var mdVSNewFrameMapShape = _utils2.default.pick(
                    this.mdVSShapeFrame,
                    mdVSUserKeysShape,
                  );
            ...
            },
            {
              ...
              value: function drawCustomShapeInstance(
                prevTexture,
                sides,
                isTextured,
                hasBorder,
                ...
                var updatedPositions = new Float32Array(
                ...
                var updatedColors = new Float32Array(
                  this.colors.buffer,
                  0,
                  (sides + 2) * 4,
                );
                ...
                if (isTextured) {
                  var updatedUvs = new Float32Array(
                    this.uvs.buffer,
                    0,
                    (sides + 2) * 2,
                  );
                ...
                if (hasBorder) {
                  ...
                  var updatedBorderPos = new Float32Array(
          ...
          (0, _createClass3.default)(Border, [
            ...
            },
            {
              ...
              value: function drawBorder(
                ...
                if (
                  this.generateBorder(borderColor, borderSize, prevBorderSize)
                ) {
                  this.gl.useProgram(this.shaderProgram);
        ...
        var WarpShader = (function () {
          ...
          (0, _createClass3.default)(WarpShader, [
            ...
            },
            {
              ...
              value: function createShader() {
                ...
                if (shaderText.length === 0) {
                  ...
                  var shaderParts =
                    _shaderUtils2.default.getShaderParts(shaderText);
                  fragShaderHeaderText = shaderParts[0];
                  fragShaderText = shaderParts[1];
                }

                fragShaderText = fragShaderText.replace(
                  /texture2D/g,
                  "texture",
                );
                fragShaderText = fragShaderText.replace(
                ...
                this.userTextures =
                  _shaderUtils2.default.getUserSamplers(fragShaderHeaderText);
            ...
            },
            {
              ...
              value: function renderQuadTexture(
                blending,
                texture,
                blurTexture1,
                blurTexture2,
          ...
          (0, _createClass3.default)(
            ...
            [
              ...
              },
              {
                ...
                value: function generateCompColors(
                  blending,
                  mdVSFrame,
                  warpColor,
                ) {
                  ...
                  for (var j = 0; j < gridY1; j++) {
                    for (var i = 0; i < gridX1; i++) {
                      ...
                      if (blending) {
                        ...
                        var dy = y - ny;
                        var alpha00 =
                          warpColor[(ny * (this.mesh_width + 1) + nx) * 4 + 3];
                        var alpha01 =
                          warpColor[
                            (ny * (this.mesh_width + 1) + (nx + 1)) * 4 + 3
                          ];
                        var alpha10 =
                          warpColor[
                            ((ny + 1) * (this.mesh_width + 1) + nx) * 4 + 3
                          ];
                        var alpha11 =
                          warpColor[
                            ((ny + 1) * (this.mesh_width + 1) + (nx + 1)) * 4 +
                              3
                          ];
                        alpha =
                          alpha00 * (1 - dx) * (1 - dy) +
              ...
              },
              {
                ...
                value: function renderQuadTexture(
                  ...
                  var compColors = this.generateCompColors(
                    blending,
                    mdVSFrame,
                    warpColor,
                  );
                  ...
                  this.gl.uniform1f(
                    this.echoOrientationLoc,
                    mdVSFrame.echo_orient,
                  );
                ...
                value: function generateHueBase(mdVSFrame) {
                  ...
                  for (var i = 0; i < 4; i++) {
                    ...
                    hueBase[i * 3 + 2] =
                      ...
                      0.3 *
                        Math.sin(
                          mdVSFrame.time * 30.0 * 0.0129 +
                            6 +
                            i * 9 +
                            mdVSFrame.rand_start[2],
                        );
                    var maxshade = Math.max(
                      hueBase[i * 3],
                      hueBase[i * 3 + 1],
                      hueBase[i * 3 + 2],
                    );
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var BlurShader = (function () {
          function BlurShader(blurLevel, blurRatios, gl) {
            ...
            this.blurHorizontal = new _blurHorizontal2.default(
              gl,
              this.blurLevel,
              opts,
            );
            this.blurVertical = new _blurVertical2.default(
              gl,
              this.blurLevel,
              opts,
            );
          ...
          (0, _createClass3.default)(BlurShader, [
            ...
            },
            {
              ...
              value: function setupFrameBufferTextures() {
                ...
                var srcTexsizeHorizontal = this.getTextureSize(
                  srcBlurRatios[1],
                );
                var dstTexsizeHorizontal = this.getTextureSize(
                  dstBlurRatios[0],
                );
                this.bindFrameBufferTexture(
                ...
                this.horizontalTexsizes = [
                  srcTexsizeHorizontal,
                  dstTexsizeHorizontal,
                ];
                this.verticalTexsizes = [
                  srcTexsizeVertical,
                  dstTexsizeVertical,
                ];
              },
            ...
            },
            {
              ...
              value: function renderBlurTexture(
                prevTexture,
                mdVSFrame,
                blurMins,
                blurMaxs,
          ...
          (0, _createClass3.default)(BlurHorizontal, [
            ...
            },
            {
              ...
              value: function getScaleAndBias(blurMins, blurMaxs) {
                ...
                tempMin =
                  (blurMins[1] - blurMins[0]) / (blurMaxs[0] - blurMins[0]);
                tempMax =
                  (blurMaxs[1] - blurMins[0]) / (blurMaxs[0] - blurMins[0]);
                scale[1] = 1.0 / (tempMax - tempMin);
                bias[1] = -tempMin * scale[1];
                tempMin =
                  (blurMins[2] - blurMins[1]) / (blurMaxs[1] - blurMins[1]);
                tempMax =
                  (blurMaxs[2] - blurMins[1]) / (blurMaxs[1] - blurMins[1]);
              ...
              },
              {
                ...
                value: function createNoiseVolTex(noiseSize, zoom) {
                  ...
                  for (var i = 0; i < nsize; i++) {
                    texArr[i * 4 + 0] = Math.floor(
                      Math.random() * texRange + halfTexRange,
                    );
                    texArr[i * 4 + 1] = Math.floor(
                      Math.random() * texRange + halfTexRange,
                    );
                    texArr[i * 4 + 2] = Math.floor(
                      Math.random() * texRange + halfTexRange,
                    );
                    texArr[i * 4 + 3] = Math.floor(
                      Math.random() * texRange + halfTexRange,
                    );
                  }
                          ...
                          if (x % zoom !== 0) {
                            ...
                            for (var _i = 0; _i < 4; _i++) {
                              y0[_i] =
                                texArr[
                                  baseY * 4 +
                                    ((baseX - zoom) % noiseSize) * 4 +
                                    _i
                                ];
                              y1[_i] =
                                texArr[
                                  baseY * 4 + (baseX % noiseSize) * 4 + _i
                                ];
                              y2[_i] =
                                texArr[
                                  baseY * 4 +
                              ...
                              y3[_i] =
                                texArr[
                                  baseY * 4 +
                                    ((baseX + zoom * 2) % noiseSize) * 4 +
                                    _i
                                ];
                            }

                            var t = (x % zoom) / zoom;
                            var result = Noise.dwCubicInterpolate(
                              y0,
                              y1,
                              y2,
                              y3,
                    ...
                    for (var _z = 0; _z < noiseSize; _z += zoom) {
                      for (var _x = 0; _x < noiseSize; _x++) {
                        for (var _y = 0; _y < noiseSize; _y++) {
                          if (_y % zoom !== 0) {
                            var _baseY =
                              Math.floor(_y / zoom) * zoom + noiseSize;
                            ...
                            for (var _i3 = 0; _i3 < 4; _i3++) {
                              ...
                              _y3[_i3] =
                                texArr[
                                  (_baseY % noiseSize) * wordsPerLine * 4 +
                                    _offset
                                ];
                              _y4[_i3] =
                                texArr[
                            ...
                            var _t = (_y % zoom) / zoom;
                            var _result = Noise.dwCubicInterpolate(
                              _y2,
                              _y3,
                              _y4,
                              _y5,
                            ...
                            for (var _i4 = 0; _i4 < 4; _i4++) {
                              ...
                              texArr[_y * wordsPerLine * 4 + _offset2] =
                                _result[_i4];
                            }
                          }
                        }
                      ...
                      for (var _y6 = 0; _y6 < noiseSize; _y6++) {
                        for (var _z2 = 0; _z2 < noiseSize; _z2++) {
                          if (_z2 % zoom !== 0) {
                            ...
                            var _baseZ =
                              Math.floor(_z2 / zoom) * zoom + noiseSize;
                            ...
                            for (var _i5 = 0; _i5 < 4; _i5++) {
                              ...
                              _y8[_i5] =
                                texArr[
                                  (_baseZ % noiseSize) * wordsPerSlice * 4 +
                                    _offset3
                                ];
                              _y9[_i5] =
                                texArr[
                            ...
                            var _result2 = Noise.dwCubicInterpolate(
                              _y7,
                              _y8,
                              _y9,
                              _y10,
                            ...
                            for (var _i6 = 0; _i6 < 4; _i6++) {
                              ...
                              texArr[_z2 * wordsPerSlice * 4 + _offset4] =
                                _result2[_i6];
                            }
                          }
                        }
                  ...
                  if (zoom > 1) {
                      ...
                      for (var x = 0; x < noiseSize; x++) {
                        if (x % zoom !== 0) {
                          ...
                          for (var z = 0; z < 4; z++) {
                            y0[z] =
                              texArr[
                                baseY * 4 + ((baseX - zoom) % noiseSize) * 4 + z
                              ];
                            y1[z] =
                              texArr[baseY * 4 + (baseX % noiseSize) * 4 + z];
                            y2[z] =
                              texArr[
                                baseY * 4 + ((baseX + zoom) % noiseSize) * 4 + z
                              ];
                    ...
                    for (var _x3 = 0; _x3 < noiseSize; _x3++) {
                      for (var _y11 = 0; _y11 < noiseSize; _y11++) {
                        if (_y11 % zoom !== 0) {
                          var _baseY3 =
                            Math.floor(_y11 / zoom) * zoom + noiseSize;
                          ...
                          for (var _z4 = 0; _z4 < 4; _z4++) {
                            _y12[_z4] =
                              texArr[
                                ((_baseY3 - zoom) % noiseSize) * noiseSize * 4 +
                                  _x3 * 4 +
                                  _z4
                              ];
                            _y13[_z4] =
                              texArr[
                                (_baseY3 % noiseSize) * noiseSize * 4 +
                                  _x3 * 4 +
                                  _z4
                              ];
                            _y14[_z4] =
                          ...
                          var _result3 = Noise.dwCubicInterpolate(
                            _y12,
                            _y13,
                            _y14,
                            _y15,
                          ...
                          for (var _z5 = 0; _z5 < 4; _z5++) {
                            texArr[_y11 * noiseSize * 4 + _x3 * 4 + _z5] =
                              _result3[_z5];
                          }
                        }
                      }
          ...
          (0, _createClass3.default)(TitleText, [
            {
              ...
              value: function generateTitleTexture(text) {
                ...
                this.context2D.font =
                  "italic " + this.fontSize + "px Times New Roman";
                  ...
                  if (y1 - y0 >= 2) {
                    if (x0 === 0) {
                      this.vertInfoC[midy * (this.mesh_width + 1) + x0] =
                        0.5 * (t00 + t10) +
                        (Math.random() * 2 - 1) * dt * this.aspecty;
                    }
                  ...
                  if (x1 - x0 >= 2) {
                    if (y0 === 0) {
                      this.vertInfoC[y0 * (this.mesh_width + 1) + midx] =
                        0.5 * (t00 + t01) +
                        (Math.random() * 2 - 1) * dt * this.aspectx;
                    }
              ...
              },
              {
                ...
                value: function createBlendPattern() {
                  ...
                  if (mixType === 0) {
                    ...
                    var _band2 =
                      0.02 + 0.14 * Math.random() + 0.34 * Math.random();
            ...
            [
              {
                ...
                value: function resizeMatrixValues(
                  oldMat,
                  oldWidth,
                  oldHeight,
                  newWidth,
